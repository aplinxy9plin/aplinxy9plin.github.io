...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'Dimadata/Dima_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'Dimadata/Dima_messages_','.xml');
}
...
function addKolorFloorPlan(pPlugID, pContent)
{
	...
	{
		var kolorFloorPlanCSS = new ktools.CssStyle("KolorFloorPlanCSS", crossDomainTargetUrl+"Dimadata/graphics/KolorFloorPlan/kolorFloorPlan.css");
		var kolorFloorPlanJS = new ktools.Script("KolorFloorPlanJS", crossDomainTargetUrl+"Dimadata/graphics/KolorFloorPlan/KolorFloorPlan.min.js", [], true);
...
function showKolorFloorPlan(pPlugID, pContent)
{
	...
	if(!kolorFloorPlan.isReady())
	{
		...
		//set url for images
		kolorFloorPlan.setGraphicsUrl(crossDomainTargetUrl+"Dimadata/graphics/"+pPlugID.toLowerCase()+"/");
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"Dimadata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"Dimadata/graphics/KolorArea/KolorArea.min.js", [], true);
